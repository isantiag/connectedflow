...
export function loadDatabaseConfig(): DatabaseConfig {
  return {
    postgres: {
      ...
      user: envOrDefault('PG_USER', 'connectedflow'),
      password: envOrDefault('PG_PASSWORD', 'connectedflow_dev'),
      database: envOrDefault('PG_DATABASE', 'connectedflow'),
    ...
    timescale: {
      ...
      user: envOrDefault('TS_USER', 'connectedflow'),
      password: envOrDefault('TS_PASSWORD', 'connectedflow_dev'),
      database: envOrDefault('TS_DATABASE', 'connectedflow_timeseries'),
